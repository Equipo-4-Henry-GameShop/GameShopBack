...
// User.belongsToMany(Venta, { through: "userventa" });
// Venta.belongsToMany(User, { through: "userventa" });
// User.belongsToMany(Videogame, { through: "usersvideoGame" });
// Videogame.belongsToMany(User, { through: "usersvideogame" });
